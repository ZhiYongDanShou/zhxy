...
public class Swagger2Config {
    ...
    public Docket webApiConfig(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //可以测试请求头中：输入token
//                .apis(RequestHandlerSelectors.withClassAnnotation(ApiOperation.class)) //扫描所有包下的注解
                .apis(RequestHandlerSelectors.basePackage("com.atguigu.zhxy.controller")) //controller层下的注解
                //过滤掉admin路径下的所有页面
